...
*/
  constructor(tiling: TilingGenerator, window: AppWindow);
/**
* @param {number} width
* @param {number} height
*/
...
* @param {number} depth
*/
  set_tiling(tiling: TilingGenerator, depth: number): void;
/**
* @param {number} depth
*/
...
* @param {string} s
*/
  constructor(p: number, q: number, s: string);
}
...
export interface InitOutput {
  ...
  readonly app_set_tiling: (a: number, b: number, c: number) => void;
  ...
  readonly __wbg_tilinggenerator_free: (a: number) => void;
  readonly tilinggenerator_new: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9e053607821a3eb6: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h718255377ef2031d: (a: number, b: number, c: number, d: number) => void;
