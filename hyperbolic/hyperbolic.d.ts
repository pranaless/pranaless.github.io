...
* @param {number} y
*/
  update_delta(x: number, y: number): void;
/**
*/
  reset_delta(): void;
/**
...
* @param {string} name
*/
  set_projection(name: string): void;
/**
*/
  draw(): void;
}
...
*/
  constructor(canvas: HTMLCanvasElement, redraw: Function);
}
...
export interface InitOutput {
  ...
  readonly app_new: (a: number) => number;
  readonly app_resize: (a: number, b: number, c: number) => void;
  readonly app_update_delta: (a: number, b: number, c: number) => void;
  readonly app_reset_delta: (a: number) => void;
  readonly app_set_depth: (a: number, b: number) => void;
  readonly app_set_projection: (a: number, b: number, c: number) => void;
  readonly app_draw: (a: number) => void;
  readonly __wbg_appwindow_free: (a: number) => void;
  readonly appwindow_new: (a: number, b: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h44e9d052c4359382: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h468ce0c924cad8ff: (a: number, b: number, c: number, d: number) => void;
