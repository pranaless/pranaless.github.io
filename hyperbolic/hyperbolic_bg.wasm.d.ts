...
export function app_resize(a: number, b: number, c: number): void;
export function app_update_delta(a: number, b: number, c: number): void;
export function app_reset_delta(a: number): void;
export function app_set_tiling(a: number, b: number, c: number): void;
export function app_set_depth(a: number, b: number): void;
export function app_set_projection(a: number, b: number, c: number): void;
export function app_draw(a: number): void;
export function __wbg_tilinggenerator_free(a: number): void;
export function tilinggenerator_new(a: number, b: number, c: number, d: number): number;
export function __wbg_appwindow_free(a: number): void;
export function appwindow_new(a: number, b: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9e053607821a3eb6(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h718255377ef2031d(a: number, b: number, c: number, d: number): void;
