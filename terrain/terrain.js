...
export class Map {
    ...
    */
    constructor(size_x, size_y, min_z, max_z, roughness) {
        const ret = wasm.map_new(size_x, size_y, min_z, max_z, roughness);
    ...
    */
    generate_seeded(seed) {
        wasm.map_generate_seeded(this.ptr, !isLikeNone(seed), isLikeNone(seed) ? 0n : seed);
    }
    /**
    * @param {HTMLTableElement} table
    */
    to_html_table(table) {
        wasm.map_to_html_table(this.ptr, addHeapObject(table));
    }
    /**
    * @returns {string}
    */
    to_table() {
        try {
            ...
            wasm.map_to_table(retptr, this.ptr);
    ...
    */
    to_data_uri() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.map_to_data_uri(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
function getImports() {
    ...
    imports.wbg.__wbg_insertRow_ce98ef34ad3d685f = function() { return handleError(function (arg0) {
        const ret = getObject(arg0).insertRow();
        return addHeapObject(ret);
    }, arguments) };
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('terrain_bg.wasm', import.meta.url);
    }
    const imports = getImports();
